...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("HAPPY TO INVITE YOU")
        p1 = PhotoImage(file='./images/bank1.png')
        window.iconphoto(True, p1)
        window.configure(background="#da88eb")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#377a64", borderwidth="0", insertbackground="black",
                                 relief="ridge",
                                 selectbackground="lightgreen", selectforeground="white")
        self.Canvas1.place(relx=0.190, rely=0.228, relheight=0.496, relwidth=0.622)

        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#60fdbc",
                                 activeforeground="#000000", background="#60fdbc", disabledforeground="#a3a3a3",
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        window.maxsize(1370, 749)
        window.resizable(0, 0)
        window.title("CREATEA ACCOUNTANT")
        window.configure(background="#f2f3f4")
        window.configure(highlightbackground="e6ff02#")
...
class createAdmin:
    def __init__(self, window=None):
        ...
        self.Label2 = tk.Label(window, background="e6ff02#", disabledforeground="#a3a3a3", foreground="#000000",
                               text='''Enter password:''')
